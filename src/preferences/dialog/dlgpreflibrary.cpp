...
void DlgPrefLibrary::slotResetToDefaults() {
    ...
    checkBox_rekordbox_main_cue->setChecked(true);
}
...
void DlgPrefLibrary::slotUpdate() {
    ...
    checkBox_rekordbox_main_cue->setChecked(
            m_pConfig->getValue(mixxx::library::kMainCuePromotionConfigKey, true));
...
void DlgPrefLibrary::slotApply() {
    ...
    m_pConfig->set(mixxx::library::kMainCuePromotionConfigKey,
            ConfigValue(checkBox_rekordbox_main_cue->isChecked()));
